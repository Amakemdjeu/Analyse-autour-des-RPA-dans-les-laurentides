...
// --- Fichiers de données ---
const FICHIERS = {
  mrc:          "mrc_laurentides.geojson",
  residences:   "residences.geojson",
  zones:        "zone_desserte.geojson",
  alimentation: "alimentation.geojson",
  sante:        "sante.geojson",
  parcs:        "parcs_laurentide.geojson",
  loisirs:      "loisirs_socialisation.geojson",
  services:     "services_complementaires.geojson",
  transport:    "transport_commun.geojson"
};
...
function htmlEntete() {
  return `
    <div class="entete">
      ...
      <div class="entete-texte">Cette application permet d'évaluer le milieu de vie autour des résidences pour personnes âgées dans la région des Laurentides.</div>
      <div class="entete-badge">Zone desserte 750 m • Score du milieu de vie • Défavorisation matérielle et sociale</div>
    </div>`;
}
